...
import type { useTools, SidebarWork } from '@/pages/Tools/useTools'

export function TlHistorySidebar(p: ReturnType<typeof useTools>) {
    ...
    <aside className="flex flex-col rounded-2xl border border-border bg-card shadow-md">
      <header className="flex items-center justify-between border-b border-border px-5 py-4">
        <div className="flex items-center gap-2">
          ...
          <h2 className="text-lg font-bold">處理歷史</h2>
        </div>
